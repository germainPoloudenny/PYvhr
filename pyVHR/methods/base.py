    ...
    def runOffline(self, **kwargs):
        ...
        while True:
            ...
            if self.ROImask == 'rect':
                if 'rectCoords' in kwargs.keys():
            	
                    rects = kwargs['rectCoords']
                    self.rectCoords = []
                    for x in rects:
                        rect = []
                        for y in x:
                    ...
                    print(self.rectCoords)
                    self.video.setMask(self.ROImask, rectCoords=self.rectCoords)
                else :
                    rects = (kwargs['rectRegions'])
                    self.rectRegions = []
                    rect = []
                    for x in rects:
                        rect.append(str(x))
                    self.rectRegions=rect
                    self.video.setMask(self.ROImask, rectRegions=self.rectRegions)
                ...
                raise ValueError(self.ROImask + " : ROI invalides !")
            ...
            print(rPPG)
            with open('csv/'+kwargs['csv_filename'],mode='w',newline='') as csvfile :
            	writer = csv.writer(csvfile)
            	writer.writerow(rPPG)
